...
### validate
    ...
    mixed SwaggerValidator\Object\Paths::validate(\SwaggerValidator\Common\Context $context)
...
### getModel
    ...
    mixed SwaggerValidator\Object\Paths::getModel(\SwaggerValidator\Common\Context $context, $paramsResponses)
