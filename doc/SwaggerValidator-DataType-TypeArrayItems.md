SwaggerValidator\DataType\TypeArrayItems
===============
...
### validate
    ...
    mixed SwaggerValidator\DataType\TypeArrayItems::validate(\SwaggerValidator\Common\Context $context, $valueParams)
...
### countItems
    ...
    mixed SwaggerValidator\DataType\TypeArrayItems::countItems(\SwaggerValidator\Common\Context $context, $additionItems, $valueParams)
