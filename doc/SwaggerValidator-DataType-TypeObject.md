SwaggerValidator\DataType\TypeObject
===============
...
### $additionalProperties
    ...
    protected array $additionalProperties = array()
...
### jsonUnSerializeProperties

    mixed SwaggerValidator\DataType\TypeObject::jsonUnSerializeProperties(\SwaggerValidator\Common\Context $context, $jsonData)
...
### validate
    ...
    mixed SwaggerValidator\DataType\TypeObject::validate(\SwaggerValidator\Common\Context $context)
...
### getModel
    ...
    mixed SwaggerValidator\DataType\TypeObject::getModel(\SwaggerValidator\Common\Context $context)
