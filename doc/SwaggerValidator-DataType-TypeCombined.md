SwaggerValidator\DataType\TypeCombined
===============
...
### validate
    ...
    mixed SwaggerValidator\DataType\TypeCombined::validate(\SwaggerValidator\Common\Context $context, $valueParams)
...
### validateAnyOf
    ...
    mixed SwaggerValidator\DataType\TypeCombined::validateAnyOf(\SwaggerValidator\Common\Context $context, $valueParams)
...
### validateAllOf
    ...
    mixed SwaggerValidator\DataType\TypeCombined::validateAllOf(\SwaggerValidator\Common\Context $context, $valueParams)
...
### validateOneOf
    ...
    mixed SwaggerValidator\DataType\TypeCombined::validateOneOf(\SwaggerValidator\Common\Context $context, $valueParams)
...
### getModel
    ...
    mixed SwaggerValidator\DataType\TypeCombined::getModel(\SwaggerValidator\Common\Context $context)
