 ...
 * @version 1.0.0
 */
class SwaggerInstagramSmokeTest extends genericTestClass
{

    public function testSmokeModel()
    {
        $this->swaggerFilePath = PHPUNIT_PATH_EXAMPLE . 'swaggerInstagram.json';
        $this->swaggerBuild();
        $this->loadModel();
    ...
    {
        $this->swaggerFilePath = PHPUNIT_PATH_EXAMPLE . 'swaggerInstagram.json';
        $swaggerDocExpected    = PHPUNIT_PATH_EXPECTED . 'swaggerInstagram.json';
